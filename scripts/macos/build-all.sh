...
cd "$ROOT"
GOOS=darwin GOARCH="${GOARCH:-arm64}" go build -o "$BIN/tes" ./cmd/tes
GOOS=darwin GOARCH="${GOARCH:-arm64}" go build -o "$BIN/tesc" ./cmd/teslang
GOOS=darwin GOARCH="${GOARCH:-arm64}" go build -o "$BIN/tesvm" ./cmd/tesvm
